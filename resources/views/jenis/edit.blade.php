    ...
    <div class="dashboard-header-banner position-relative">
        <div class="position-relative" style="z-index: 1;">
            <h2 class="fw-bold text-white mb-2 d-flex align-items-center gap-2">
                <i class="bi bi-pencil-square fs-2"></i> {{ __('edit_category') }}
            </h2>
            <p class="text-white opacity-75 mb-0">{{ __('edit_category_subtitle') }}</p>
        </div>
    </div>
        ...
        <form action="{{ route('jenis.update', $jeni) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                       id="nama" name="nama" value="{{ old('nama', $jeni->nama) }}"
